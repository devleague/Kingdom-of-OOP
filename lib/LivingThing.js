export default class LivingThing {
  constructor( name, uniCellular, trueNucleus, anaerobic, asexual, mobile ){
    ...
    this._eukaryote = trueNucleus;
    this._prokaryote = trueNucleus;
  ...
  set aerobic( aerobic ){
    if ( typeof (aerobic) === 'boolean') {
      ...
      throw new TypeError('LivingThing.aerobic must be boolean');
    }
  }
  get asexual(){
  ...
  set asexual( asexual ){
    ...
    throw new TypeError('LivingThing.asexual must be boolean');
    }
  }
  get sexual(){
    return !this._asexual;
  ...
  set sexual( sexual ){
    if ( typeof (sexual) === 'boolean') {
      ...
      throw new TypeError('LivingThing.sexual must be boolean');
    }
  }
  get mobile(){
    return this._mobile;
